 ...
 */
public class Test4 {
    private String fileName = "src/test/resources/input4.txt";
    private String fileNameOut = "src/test/resources/output4.txt";
    private String fileNameOutR = "src/test/resources/output4_right.txt";
